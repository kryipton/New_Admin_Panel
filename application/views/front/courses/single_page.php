        ...
        <div class="course-detail">
            <div class="row">
                <div class="col-md-8 col-sm-12">
                    <div class="post_img">
                        <img src="<?php echo base_url("uploads/courses/").$course["img"] ?>"  alt="">
                    </div>
                    <div class="course-tabs">
                        ...
                        <div class="eve-content">
                            <div class="over-view">
                                ...
                                <span> <b><?php echo $this->lang->line("ders_saati"); ?> : </b>        <?php echo $course['lesson_start_hour']."-".$course['lesson_end_hour']  ?> </span><br>
